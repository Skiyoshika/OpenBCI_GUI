...
use crate::buffer::{SignalBuffer, TimeSeriesFrame};
use crate::error::ModelizeError;
use crate::fft::{FrequencySpectrum, SpectrumBuilder};
use crate::source::{SignalBatch, SignalSource};
...
mod tests {
    use super::*;
    use crate::plot::{PlotStyle, render_spectrum_png, render_waveform_png};
