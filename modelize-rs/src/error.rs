...
impl From<plotters::drawing::DrawingAreaErrorKind<plotters::style::color::RGBColor>>
    for ModelizeError
{
    fn from(
        value: plotters::drawing::DrawingAreaErrorKind<plotters::style::color::RGBColor>,
    ) -> Self {
